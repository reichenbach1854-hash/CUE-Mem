...
DEFAULT_APILLM = {
    'method': 'APILLM',
    'name': os.environ.get('CUE_MEM_LLM_MODEL', ''),
...
# ----- Encode -----
# GME Encoder Configuration (for multimodal mode)
DEFAULT_GME_ENCODER = {
    'method': 'LMEncoder',
...
# Lightweight text-only encoder (for caption/text mode)
DEFAULT_ST_ENCODER = {
    'method': 'STEncoder',
    'name': 'paraphrase-multilingual-MiniLM-L12-v2',
    'dimension': 384,
    'path': os.environ.get('CUE_MEM_TEXT_ENCODER_PATH', '')
}

DEFAULT_ENCODER = DEFAULT_ST_ENCODER
